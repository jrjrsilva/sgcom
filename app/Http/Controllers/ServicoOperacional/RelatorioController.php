...
use sgcom\Models\RelatorioServico;
...
class RelatorioController extends Controller
{
  ...
  {
    $ocorrencias = Ocorrencia::whereYear('data', '=', date('Y'))
      ->orderBy('data', 'desc')
      ->paginate($this->totalPage);

    $relatorios = RelatorioServico
      // ::where('data_servico', '=', date('Y'))
    ...
    //dd($relatorios);
    return view(
      'servicooperacional.relatorios.listar',
      compact('ocorrencias', 'relatorios', 'tiposocorrencias', 'cvli', 'cvp', 'pcvli', 'pcvp', 'phomicidio', 'homicidio')
    );
  }
