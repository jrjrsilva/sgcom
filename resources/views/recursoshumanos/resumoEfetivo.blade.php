...
<div class="row">
   <div class="col-md-4 col-sm-6 col-12">
          ...
          <span class="info-box-icon"><i class="fa fa-bar-chart"></i></span>
              ...
              <span class="info-box-number">Sala de Rádio: {{ $restricoes}}</span>
     ...
     <div class="col-md-3 col-sm-6 col-12">
          ...
          <span class="info-box-icon"><i class="fa fa-bar-chart"></i></span>
              ...
              <span class="info-box-number">Com Restrição: {{ $restricoes}}</span>
              <span class="info-box-number">Sem Restrição: {{ $gestantes}}</span>
              <span class="info-box-number">Total Administrativo: {{ $agregados}}</span>
            </div>
        <!-- /.info-box-content -->
        </div>
        </div>
 ...
 <div class="container" style="display: block;">
        ...
        <div class="row">
          ...
          <div class="col-md-4 col-sm-6 col-12">
            ...
            <canvas width="300" height="225" id="grafico"></canvas>
          </div>
       </div>
</div>
